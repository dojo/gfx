...
```bash
$ git clone git@github.com:username/gfx.git
```

This will clone your fork to your current path in a directory named `gfx`.
...
```bash
$ cd gfx
$ git remote add upstream git@github.com:ibm-dojo/gfx.git
$ git fetch upstream
```
