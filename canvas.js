...
function(g, lang, arr, declare, win, domGeom, dom, gs, pathLib, ga, m, decompose, bezierUtils ){
	...
	canvas.Shape = declare("gfx.canvas.Shape", gs.Shape, {
	...
	canvas.Group = declare("gfx.canvas.Group", canvas.Shape, {
		// summary:
	...
	canvas.Rect = declare("gfx.canvas.Rect", [canvas.Shape, gs.Rect], {
		// summary:
	...
	canvas.Ellipse = declare("gfx.canvas.Ellipse", [canvas.Shape, gs.Ellipse], {
		// summary:
	...
	canvas.Circle = declare("gfx.canvas.Circle", [canvas.Shape, gs.Circle], {
		// summary:
	...
	canvas.Line = declare("gfx.canvas.Line", [canvas.Shape, gs.Line], {
		// summary:
		//		a line shape (Canvas)
		_renderShape: function(/* Object */ ctx){
			var s = this.shape;
	...
	canvas.Polyline = declare("gfx.canvas.Polyline", [canvas.Shape, gs.Polyline], {
		// summary:
	...
	canvas.Image = declare("gfx.canvas.Image", [canvas.Shape, gs.Image], {
		// summary:
	...
	canvas.Text = declare("gfx.canvas.Text", [canvas.Shape, gs.Text], {
		_setFont:function(){
			if(this.fontStyle){
	...
	canvas.Path = declare("gfx.canvas.Path", [canvas.Shape, pathLib.Path], {
		// summary:
		//		a path shape (Canvas)
		constructor: function(){
			this.lastControl = {};
	...
	canvas.TextPath = declare("gfx.canvas.TextPath", [canvas.Shape, pathLib.TextPath], {
		// summary:
		//		a text shape (Canvas)
		_renderShape: function(/* Object */ ctx){
			var s = this.shape;
	...
	canvas.Surface = declare("gfx.canvas.Surface", gs.Surface, {
		// summary:
