...
function(lang, has, win, dom, declare, arr, domGeom, domAttr, Color, g, gs, pathLib){
	...
	svg.Shape = declare("gfx.svg.Shape", gs.Shape, {
		// summary:
	...
	svg.Group = declare("gfx.svg.Group", svg.Shape, {
		// summary:
	...
	svg.Rect = declare("gfx.svg.Rect", [svg.Shape, gs.Rect], {
		// summary:
	...
	svg.Ellipse = declare("gfx.svg.Ellipse", [svg.Shape, gs.Ellipse], {});
	svg.Ellipse.nodeType = "ellipse";

	svg.Circle = declare("gfx.svg.Circle", [svg.Shape, gs.Circle], {});
	svg.Circle.nodeType = "circle";

	svg.Line = declare("gfx.svg.Line", [svg.Shape, gs.Line], {});
	svg.Line.nodeType = "line";

	svg.Polyline = declare("gfx.svg.Polyline", [svg.Shape, gs.Polyline], {
		// summary:
	...
	svg.Image = declare("gfx.svg.Image", [svg.Shape, gs.Image], {
		// summary:
		//		an image (SVG)
		setShape: function(newShape){
			// summary:
	...
	svg.Text = declare("gfx.svg.Text", [svg.Shape, gs.Text], {
		// summary:
	...
	svg.Path = declare("gfx.svg.Path", [svg.Shape, pathLib.Path], {
		// summary:
		//		a path shape (SVG)
	...
	svg.TextPath = declare("gfx.svg.TextPath", [svg.Shape, pathLib.TextPath], {
		// summary:
	...
	svg.Surface = declare("gfx.svg.Surface", gs.Surface, {
		// summary:
