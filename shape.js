define(["./_base", "dojo/_base/lang", "dojo/_base/declare", "dojo/_base/kernel", "dojo/_base/sniff",
	...
	shape.Shape = declare("gfx.shape.Shape", null, {
		// summary:
	...
	shape._eventsProcessing = {
		...
		connect: function(name, object, method){
			...
			// is done by gfx.fixTarget which is defined by each renderer
	...
	shape.fixCallback = function(gfxElement, fixFunction, scope, method){
		...
		//		property to the event. It should be 'gfx.fixTarget' for
		//		most of the cases
		// scope: Object
		...
		if(lang.isString(method)){
			...
			if(!scope[method]){ throw(['gfx.shape.fixCallback: scope["', method, '"] is null (scope="', scope, '")'].join('')); }
			return function(e){  
	...
	shape.Surface = declare("gfx.shape.Surface", null, {
		// summary:
	...
	/*=====
	g.Point = declare("gfx.Point", null, {
		// summary:
	...
	g.Rectangle = declare("gfx.Rectangle", null, {
		// summary:
	...
	shape.Rect = declare("gfx.shape.Rect", shape.Shape, {
		// summary:
		//		a generic rectangle
	...
	shape.Ellipse = declare("gfx.shape.Ellipse", shape.Shape, {
		// summary:
		//		a generic ellipse
		constructor: function(rawNode){
			// rawNode: Node
	...
	shape.Circle = declare("gfx.shape.Circle", shape.Shape, {
		// summary:
		//		a generic circle
		constructor: function(rawNode){
			// rawNode: Node
	...
	shape.Line = declare("gfx.shape.Line", shape.Shape, {
		// summary:
	...
	shape.Polyline = declare("gfx.shape.Polyline", shape.Shape, {
		// summary:
	...
	shape.Image = declare("gfx.shape.Image", shape.Shape, {
		// summary:
