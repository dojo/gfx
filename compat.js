define(["dcl/dcl", "./_base", "./Surface", "./shapes", "require"], function (dcl, g, Surface, shapes, require) {
	// module:
	//		gfx/compat
	// summary:
	//		This the root of the Dojo Graphics packageThis module mimics the Dojo 1.9 API by adding a createSurface
	//		on the toplevel gfx module.
