...
function (lang,declare,arr,loader,xhr,gfx,xmlDomParser,HtmlMetrics,Matrix){
	var _getText = function(url){
	 ...
	 lang.getObject("gfx.VectorText", true);
	...
	return declare("gfx.VectorFont", null, {
		// summary:
		//		An implementation of the SVG Font 1.1 spec, using gfx.
		//
		//		Basic interface:
		...
		*/
		...
		draw: function(
			...
			//		The possible values are contained in the gfx.vectorFontFitting enum
			//		(NONE, FLOW, FIT).
			//
			//		`Flow fitting`
			...
			// returns: gfx.Group
			if(!this.initialized()){
				throw new Error("gfx.VectorFont.draw(): we have not been initialized yet.");
			}
		...
		onLoad: function(/* gfx/VectorText */font){ }
	});

	//		TODO: gfx integration
/*

	//		Inherit from Group but attach Text properties to it.
	dojo.declare("gfx.VectorText", gfx.Group, {
		constructor: function(rawNode){
			gfx.Group._init.call(this);
			this.fontStyle = null;
		},
		...
		_setFont: function(){
			...
			var font = gfx._vectorFontCache[f.family];
			if(!font){
				throw new Error("gfx.VectorText._setFont: the passed font family '" + f.family + "' was not found.");
			}
		...
		setShape: function(newShape){
			gfx.Group.setShape.call(this);
			this.shape = gfx.makeParameters(this.shape, newShape);
			this.bbox = null;
			this._setFont();
			return this;
		},
		...
		setFont: function(newFont){
			...
			this.fontStyle = typeof newFont == "string" ? gfx.splitFontString(newFont)
				: gfx.makeParameters(gfx.defaultFont, newFont);
			this._setFont();
			return this;
		},
	...
	gfx.shape.Creator.createVectorText = function(text){
		return this.createObject(gfx.VectorText, text);
	}
*/
});
